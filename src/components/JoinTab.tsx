...
export default function JoinTab({
  ...
  const CITY_COORDINATES: Record<string, { lat: number, lng: number }> = {
    ...
    "حضرموت": { lat: 15.421, lng: 48.452 },
    "المكلا": { lat: 14.542, lng: 49.124 },
    "سيئون": { lat: 15.945, lng: 48.784 },
    "ذمار": { lat: 14.542, lng: 44.403 },
    "البيضاء": { lat: 13.985, lng: 45.573 },
    "مأرب": { lat: 15.463, lng: 45.325 },
    "الجوف": { lat: 16.168, lng: 44.825 },
    "صعدة": { lat: 16.942, lng: 43.763 },
    "حجة": { lat: 15.701, lng: 43.602 },
    "المحويت": { lat: 15.471, lng: 43.543 },
    "عمران": { lat: 15.659, lng: 43.943 },
    "الضالع": { lat: 13.695, lng: 44.731 },
    "لحج": { lat: 13.056, lng: 44.881 },
    "أبين": { lat: 13.123, lng: 45.378 },
    "شبوة": { lat: 14.532, lng: 46.831 },
    "سقطرى": { lat: 12.463, lng: 53.823 }
  };
